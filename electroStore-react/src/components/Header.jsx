function Header({ cart, eliminarProducto, vaciarCarrito, estaVacio, totalPagar }) {
  return (
    <>
      <header className="header contenedor">
        ...
        <div className="contenedor-carrito">
          ...
          <div className="carrito-dropdown" id="carrito">
            {estaVacio? (
              ...
              <>
                <table id="lista-carrito">
                  ...
                  <tbody>
                   {cart.map(producto =>
                        <tr key={producto.id}>
                            <td>
                                <img loading="lazy" src={`img/${producto.imagen}.jpg`} alt="imagen" />
                            </td>
                            <td>{producto.titulo}</td>
                            <td>{producto.precio}</td>
                            <td>{producto.cantidad}</td>
                            <td>
                                <a className="borrar-producto" onClick={()=> eliminarProducto(producto.id)}>
                                    X
                                </a>
                            </td>
                        </tr>
                ...
                <a className="vaciar-carrito-btn" onClick={vaciarCarrito}>
                  Vaciar carrito
                </a>
                <p className="total-pagar">
                  Total a pagar: <span>${totalPagar}</span>
                </p>
              </>
            )}
          </div>
